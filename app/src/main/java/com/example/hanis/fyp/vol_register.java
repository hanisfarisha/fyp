...
public class vol_register extends AppCompatActivity implements View.OnClickListener{
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            ...
                            Toast.makeText(vol_register.this, "Could not register! Please try again.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    public void onClick(View view) {
        ...
        if(view == textViewSignin){
            ...
            startActivity(new Intent(this,VolLogin.class));
        }
    }
}
